...
class ExpOptimizationModel(torch.nn.Module):
    ...
    def generate_explanation(self):
        ...
        for user, items in tqdm.tqdm(list(self.rec_dict.items())[:4]):
            ...
            for item in items[: self.exp_args.rec_k]:
                ...
                if explanation_features is None:
                    ...
                    print("explan:", explanation_features, exp_num, exp_complexity)
    ...
    def user_side_evaluation(self):
        from evaluate_functions import evaluate_user_perspective, evaluate_model_perspective
    ...
    def model_side_evaluation(self):
        from evaluate_functions import evaluate_model_perspective
