...
def arg_parse_train_base():
    ...
    parser.add_argument("--rec_k", dest="rec_k", type=int, default=1, help="length of rec list")
    return parser.parse_args()
...
def arg_parse_exp_optimize():
    ...
    parser.add_argument("--step", dest="step", type=int, default=10000, help="# of steps in optimization")
